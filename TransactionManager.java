...
public class TransactionManager {
    public static void main(String[] args) {
        ...
        Visa transaccion1 = new Visa("Usuario1", 1, "Public1", 100.0, 1234567890123456L, 1224, 123);
        Visa transaccion2 = new Visa("Usuario2", 2, "Public2", 200.0, 2345678901234567L, 0623, 456);
